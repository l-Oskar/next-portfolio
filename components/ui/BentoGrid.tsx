...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("fediuk_v@protonmail.com");
    ...
    <div
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        <div
          className={cn(
            titleClassName,
            id !== 6 && id !== 2 ? "group-hover/bento:translate-x-2" : "",
            "transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-8"
          )}>
